...
import md from '../../docs_egaand/08_recuperacion_egaand.md?raw';
...
const estilos = {
  ...
  code: (props) => <code className="bg-slate-100 dark:bg-slate-950 px-1.5 py-0.5 rounded font-mono text-xs text-cyan-600 dark:text-cyan-400 border border-slate-200 dark:border-slate-800" {...props} />,
  ...
  return (
    <div className="space-y-6 animate-fadeIn text-slate-800 dark:text-slate-100 transition-colors duration-300">
      <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-4">
        <div className="p-2.5 bg-cyan-50 dark:bg-cyan-500/10 border border-cyan-200 dark:border-cyan-500/30 rounded-xl text-cyan-600 dark:text-cyan-400 shrink-0">
          <RefreshCw size={24} />
        </div>
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Plan de Recuperación ante Desastres (DRP)</h1>
          <span className="text-xs font-mono text-cyan-600 dark:text-cyan-400">Origen: docs_egaand/08_recuperacion_egaand.md</span>
        </div>
      </div>
