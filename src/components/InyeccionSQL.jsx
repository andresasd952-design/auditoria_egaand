  ...
  return (
    <div className="space-y-6 animate-fadeIn text-slate-800 dark:text-slate-100 transition-colors duration-300">
      <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">1. Inyección SQL (SQLi)</h1>
          <span className="text-xs font-mono text-cyan-600 dark:text-cyan-400">Origen: docs_egaand/02_sqli_egaand.md</span>
        </div>
      </div>
