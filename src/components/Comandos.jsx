  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
        <div className="p-2.5 bg-red-500/10 border border-red-500/30 rounded-xl text-red-400 shrink-0"><Terminal size={24} /></div>
        <div>
          <h1 className="text-2xl font-bold text-white">3. Command Injection</h1>
          <span className="text-xs font-mono text-cyan-400">Origen: docs_egaand/04_comandos_egaand.md</span>
        </div>
      </div>
