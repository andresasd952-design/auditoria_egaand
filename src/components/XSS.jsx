...
const estilos = {
  ...
  code: props => <code className="bg-slate-950 px-1.5 py-0.5 rounded font-mono text-xs text-amber-400 border border-slate-800" {...props} />,
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
        <div className="p-2.5 bg-amber-500/10 border border-amber-500/30 rounded-xl text-amber-400 shrink-0"><Code size={24} /></div>
        <div>
          <h1 className="text-2xl font-bold text-white">2. Cross-Site Scripting (XSS Reflejado)</h1>
          <span className="text-xs font-mono text-cyan-400">Origen: docs_egaand/03_xss_egaand.md</span>
        </div>
      </div>
